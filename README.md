...
The below is just the standard README from create-vite. Ignore it if you want but I'll leave it to not create discrepencies between create-vite and this template.
